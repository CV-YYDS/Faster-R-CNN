...
import transforms
from my_dataset import VOC0712DataSet
...
def main(args):
    ...
    # 用来保存coco_info的文件
    results_file = str(16)+"results{}.txt".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
...
if __name__ == "__main__":
    ...
    #parser.add_argument('--distributed', default=True, help='distributed')
